...
| ---------------- | --------------------------------------------------------- |
| **Aqsa**         | AI Chatbot, RAG pipeline, core AI/LLM components          |
| **Mazi**         | Health Education Hub, data analysis, data sourcing        |
| **Joel**         | Health Education Hub, APIs, video content & summarization |
| **Abdul Rahman** | Medicine Manager, frontend development                    |
